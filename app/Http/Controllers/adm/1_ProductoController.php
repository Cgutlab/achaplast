...

{
...

    {
        ...
        $producto->titulo_br       = $request->titulo_br;

        $producto->breve_es        = $request->breve_es;
        $producto->breve_en        = $request->breve_en;
        $producto->breve_br        = $request->breve_br;       

        $producto->texto1_es       = $request->texto1_es;
        $producto->texto1_en       = $request->texto1_en;
        $producto->texto1_br       = $request->texto1_br;
        ...
        $producto->id_categoria = $request->id_categoria;      
          ...
          if ($request->hasFile('imagen')){
              ...
              if ($request->file('imagen')->isValid()){
                  ...
                  $path = public_path('imagenes/achaplast_productos/');
          ...
          if ($request->hasFile('pdf')){
              ...
              if ($request->file('pdf')->isValid()){
                  ...
                  $path = public_path('imagenes/achaplast_productos/pdf/');
