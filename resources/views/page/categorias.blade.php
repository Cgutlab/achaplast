...
<div class="hide-on-med-and-down cero" style="background: #EBEBEB;">
  <div class="container cero" style="width: 80%;">  
    <div class="row cero">
      <div class="Roboto verde1 fw7 fs20 cero mayus" style="padding: 20px 0 20px 10px;">@lang('general.productos')</div>
    </div>  
  </div>
</div>
...
<div class="col s12 m6 l3">
  <div class="card z-depth-0">
    ...
    <a href="{{route('achaplast', $categoria->id)}}">
        ...
        <img src="{{('imagenes/achaplast_categorias/'.$categoria->imagen)}}" style="border: 1px solid #DDD; width: 100%; height: 100%;">
    </a>
    </div>
    <div class="card-content cero center-align Roboto" style="border: 1px solid #DDD; background: #DDD;">
      <div class="Roboto fw5 fs16 gris13 editorRico Roboto">{!!($categoria->{'titulo_'.$idioma}) !!}</div>
    </div>
  </div>
</div>
@endforeach
